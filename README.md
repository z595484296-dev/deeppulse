...
![version](https://img.shields.io/badge/version-1.7.0-4f8cff) ![license](https://img.shields.io/badge/license-MIT-a855f7) ![deps](https://img.shields.io/badge/依赖-零第三方-2ebd85)
...
| 🏠 总览 | 无需提问即可生成主动简报：先检查数据质量，再把结构风险、收盘复盘、自选与提醒整理成最多三项研究任务；支持 DeepSeek 展开、已读同步与自由收起 |
