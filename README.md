...
![version](https://img.shields.io/badge/version-1.15.0-4f8cff) ![license](https://img.shields.io/badge/license-MIT-a855f7) ![deps](https://img.shields.io/badge/依赖-零第三方-2ebd85)
...
| 🏠 总览 | 无需提问即可生成主动简报；盘前、盘中、收盘三段式主动服务可分别授权；事件影响雷达把宏观/市场事件关联到敏感行业与自选 |
