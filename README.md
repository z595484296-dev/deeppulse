...
![version](https://img.shields.io/badge/version-1.12.0-4f8cff) ![license](https://img.shields.io/badge/license-MIT-a855f7) ![deps](https://img.shields.io/badge/依赖-零第三方-2ebd85)
...
| 🧭 策略 | 引擎诊断、仓位矩阵、研究假设、权重草稿、复盘日历与情绪日记；事件假设保存创建时事实、预设反证并在到期后主动提醒复盘 |
