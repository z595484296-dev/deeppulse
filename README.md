...
![version](https://img.shields.io/badge/version-1.5.2-4f8cff) ![license](https://img.shields.io/badge/license-MIT-a855f7) ![deps](https://img.shields.io/badge/依赖-零第三方-2ebd85)
...
- 对话、自选、提醒和日记写入本机 `data/profile.json`，各运行端共享；浏览器只保留同步镜像
