...
import { attentionDecision, digestMessage, makeAttentionItem, nextMorning } from './attention.js?v=1.22.1';
...
} from './store.js?v=1.22.1';
import { esc, toast } from './util.js?v=1.22.1';
