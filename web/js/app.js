...
import { state, marketState, bus, emit, loadAlerts, markTriggered, syncProfile } from './store.js?v=1.16.0';
import { esc, fmtPct, fmtPrice, pctClass, tradingState, toast } from './util.js?v=1.16.0';

import * as pageOverview from './pages/overview.js?v=1.16.0';
import * as pageEmotion from './pages/emotion.js?v=1.16.0';
import * as pageMarket from './pages/market.js?v=1.16.0';
import * as pageLadder from './pages/ladder.js?v=1.16.0';
import * as pageWatch from './pages/watch.js?v=1.16.0';
import * as pageStrategy from './pages/strategy.js?v=1.16.0';
import * as pageEpaper from './pages/epaper.js?v=1.16.0';
import * as pageDatasrc from './pages/datasrc.js?v=1.16.0';
import * as pageAbout from './pages/about.js?v=1.16.0';
import { createChatView, chatStore, ensureGreeting } from './chat.js?v=1.16.0';
import { EMBEDDED, initBridge, exitToSession, applyTheme, askDeepSeek, setBridgeContextProvider } from './bridge.js?v=1.16.0';
import { initOnboarding } from './onboarding.js?v=1.16.0';
import { attentionContext, initAttentionCenter, publishAttention } from './attention-center.js?v=1.16.0';
