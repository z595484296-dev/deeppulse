...
import { marketState, addWatch, loadWatch, emit, state } from '../store.js?v=1.38.0';
import { klineChart } from '../charts.js?v=1.38.0';
import { fmtPct, fmtPrice, fmtBig, pctClass, esc, debounce, toast, UP, DOWN, phaseBandsOf } from '../util.js?v=1.38.0';
