    ...
    vi.stubGlobal('fetch', vi.fn((input: RequestInfo | URL) => {
      ...
      if (url.includes(':8971/')) {
        return Promise.resolve(response(true, '', {
          data: { version: '1.9.0', capabilities: { research_suggestion_inbox: 1, research_suggestion_preview: 1, tdx_read_only: true } },
        }))
      }
      return Promise.resolve(response(true))
    }))
